...
> Design decisions: [`design-decisions-issue-5.md`](design-decisions-issue-5.md) — **visual/UX only**. Its API-contract notes (5-activity table, tab bar, sign-in flow, `hour` field, single top-level `rating`) are **stale**; this spec supersedes them. Reconcile against [ADR-0004](../../adr/0004-day-bucketed-rating-wire-shape.md) (response) + [ADR-0005](../../adr/0005-custom-activity-request-schema.md) (request).
