...
| 8 | #6c/#6d live acceptance (checklist: [push-client spec §6](current/implement-spec-push-client.md)) | both | **next** — needs item 4 (bundle-ID rename), the APNs entitlement in Xcode (owner, Signing & Capabilities), and a real device |
