...
- [#6a Backend infrastructure](current/implement-spec-issue-6-deploy-and-notifications.md) — PostgreSQL, Sign in with Apple verification, JWT auth, user preferences API
