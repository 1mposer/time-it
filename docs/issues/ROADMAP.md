...
- [#6b Railway deployment](current/implement-spec-issue-6b-railway-deploy.md) — ✅ **complete 2026-07-20** (`https://time-it-production.up.railway.app`; health/POST/400 probes green, Serverless off, Release URL wired into `APIConfig.swift`, real-device Release install confirmed by owner)
