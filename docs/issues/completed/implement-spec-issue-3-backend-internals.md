...
> Required by: [Issue #4 (HTTP API)](implement-spec-issue-4-http-api.md) ([GitHub](https://github.com/1mposer/time-it/issues/4)), [Issue #5a (iOS Core)](../current/implement-spec-issue-5a-ios-core.md) ([GitHub](https://github.com/1mposer/time-it/issues/5))
...
- [Issue #5a (iOS Core)](../current/implement-spec-issue-5a-ios-core.md) ([GitHub](https://github.com/1mposer/time-it/issues/5)) — depends on the JSON contract defined here (`forecastStart`, `displayMetrics`, `id`).
