...
> Required by: [Issue #5a (iOS Core)](../current/implement-spec-issue-5a-ios-core.md), [Issue #6b (Deploy)](../current/implement-spec-issue-6b-railway-deploy.md)
...
- [Issue #5a (iOS Core)](../current/implement-spec-issue-5a-ios-core.md) — the iOS app implements against the JSON contract defined in Section 4 of this issue. Do not change the response shape after Issue #5 begins.
