...
> Required by: [Issue #5a (iOS Core)](../current/implement-spec-issue-5a-ios-core.md) ([GitHub](https://github.com/1mposer/time-it/issues/5)), [Issue #6 (Deploy)](../current/implement-spec-issue-6-deploy-and-notifications.md)
