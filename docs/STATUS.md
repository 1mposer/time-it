...
**Phase 2: complete and merged into `pre-merge-main`** (`--no-ff`, `ae3e906`). Ultra-review run (2026-06-30); its two regressions fixed in `f983179`. Ready for the `pre-merge-main → main` merge.
