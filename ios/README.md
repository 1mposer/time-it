...
**UX source of truth for the next visual iteration** is the Figma file **Main - Time-it** (`t3ZRvcYPnSRPKElSLAFqmG`): full multi-page design system (Primitives/Semantic Light+Dark variables, component sheets, Light/Dark screen galleries incl. all 9 wizard frames). Access, page map, tokens, and workflow: [`docs/design/FIGMA.md`](../docs/design/FIGMA.md).
